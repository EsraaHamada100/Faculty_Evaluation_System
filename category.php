	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				<h1 class="app-page-title text-success"><span class="nav-icon"><i class="fa fa-table"></i></span> Manage
					Category</h1>
				<hr class="mb-4">
								...
								<form class="settings-form">
									<div class="mb-3">
										<table id="myTable" class="table app-table-hover mb-0 text-left">
											...
											<tbody>
												<tr>
													<td class="cell"><i class="fa fa-table"></i> Teacher</td>
													<td>
														<a
												...
												<tr>
													<td class="cell"><i class="fa fa-table"></i> Co-Teacher</td>
													<td> <a
															href="?=delete"><i class="fa fa-trash text-danger"></i></a>
													</td>
												</tr>
