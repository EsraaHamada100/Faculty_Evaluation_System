					...
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						...
						<li class="nav-item has-submenu">
							...
							<div id="submenu-4" class="collapse submenu submenu-4" data-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="add_teacher.php">Add Teacher</a></li>
									<li class="submenu-item"><a class="submenu-link" href="manage_teacher.php">Manage Teacher</a></li>
								</ul>
							</div>
							<!--//co_teacher-->
						</li>
						...
						<li class="nav-item has-submenu">
							...
							<div id="submenu-3" class="collapse submenu submenu-3" data-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									...
									<li class="submenu-item"><a class="submenu-link" href="add_co-teacher.php">Add Co_Teacher</a></li>
