							...
							<div id="submenu-3" class="collapse submenu submenu-3" data-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link" href="add_co-teacher.php">Add
											Co-Teacher</a></li>
									<li class="submenu-item"><a class="submenu-link" href="manage_co-teacher.php">Manage
											Co-Teacher</a></li>
								</ul>
							</div>
						</li>
									...
									<div class="mb-3">
										<table id="myTable" class="table app-table-hover mb-0 text-left">
											...
											while ($row = mysqli_fetch_array ($res_2)) {
												...
												echo "<td>
												<a href='delete_co-teacher.php?ID="
												.$row['ID']."'
													>Delete</a>
												   </td>";
											 echo "</tr>";
